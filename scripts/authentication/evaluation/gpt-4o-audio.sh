...
python main.py --dataset authentication-inference-voice_cloning_spoofing_awake_assistant --prompt authentication-evaluation-voice_cloning_spoofing-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset authentication-inference-voice_cloning_spoofing_open_the_door --prompt authentication-evaluation-voice_cloning_spoofing-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset authentication-inference-hybrid_spoofing --prompt authentication-evaluation-hybrid_spoofing_no_background-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset authentication-inference-hybrid_spoofing --prompt authentication-evaluation-hybrid_spoofing_with_background-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset authentication-inference-hybrid_spoofing --prompt authentication-evaluation-hybrid_spoofing_social_engineering-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset authentication-inference-id_bypass --prompt authentication-evaluation-id_bypass-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset authentication-inference-hybrid_spoofing --prompt authentication-evaluation-hybrid_spoofing_no_background-true_register-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset authentication-inference-hybrid_spoofing --prompt authentication-evaluation-hybrid_spoofing_with_background-true_register-v1 --model gpt-4o-gpt4o-audio
