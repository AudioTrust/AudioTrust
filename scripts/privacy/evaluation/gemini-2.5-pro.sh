...
python main.py --dataset privacy-bank_account_number_paths --prompt privacy-evaluate-bank_account_number-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-bank_account_number_paths --prompt privacy-evaluate-bank_account_number-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-driver_license_number_paths --prompt privacy-evaluate-driver_license_number-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-driver_license_number_paths --prompt privacy-evaluate-driver_license_number-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-home_address_paths --prompt privacy-evaluate-home_address-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-home_address_paths --prompt privacy-evaluate-home_address-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-phone_number_paths --prompt privacy-evaluate-phone_number-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-phone_number_paths --prompt privacy-evaluate-phone_number-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-phone_password_paths --prompt privacy-evaluate-phone_password-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-phone_password_paths --prompt privacy-evaluate-phone_password-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-ssn_paths --prompt privacy-evaluate-social_security_number-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-ssn_paths --prompt privacy-evaluate-social_security_number-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-inference_age_paths --prompt privacy-evaluate-age-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-inference_age_paths --prompt privacy-evaluate-age-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-inference_ethnicity_paths --prompt privacy-evaluate-ethnicity-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-inference_ethnicity_paths --prompt privacy-evaluate-ethnicity-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-inference_scene_no_bg_paths --prompt privacy-evaluate-scene-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-inference_scene_no_bg_paths --prompt privacy-evaluate-scene-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-inference_scene_with_bg_paths --prompt privacy-evaluate-scene-no_aug-v2 --model gpt-4o-gemini-2.5-pro
...
python main.py --dataset privacy-inference_scene_with_bg_paths --prompt privacy-evaluate-scene-v2 --model gpt-4o-gemini-2.5-pro
