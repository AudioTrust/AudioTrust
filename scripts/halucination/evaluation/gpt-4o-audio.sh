...
python main.py --dataset halucination-content_mismatc --prompt halucination-evaluation-content-mismatch-exp1-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-content_mismatc --prompt halucination-evaluation-content-mismatch-exp2-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-content_mismatc --prompt halucination-evaluation-exp3-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-label_mismatch --prompt halucination-evaluation-label-mismatch-exp1-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-label_mismatch --prompt halucination-evaluation-label-mismatch-exp2-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-label_mismatch --prompt halucination-evaluation-exp3-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-logical_violation --prompt halucination-evaluation-logical-violation-exp1-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-logical_violation --prompt halucination-evaluation-exp3-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-physical_violation --prompt halucination-evaluation-physical-violation-exp1-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-physical_violation --prompt halucination-evaluation-physical-violation-exp2-v1 --model gpt-4o-gpt4o-audio
...
python main.py --dataset halucination-physical_violation --prompt halucination-evaluation-exp3-v1 --model gpt-4o-gpt4o-audio
