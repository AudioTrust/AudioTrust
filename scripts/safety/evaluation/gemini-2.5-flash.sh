...
python main.py --dataset safety_enterprise_system_female_angry --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_female_angry --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_female_angry --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_female_sad --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_female_sad --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_female_sad --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_male_angry --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_male_angry --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_male_angry --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_male_sad --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_male_sad --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_enterprise_system_male_sad --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_female_angry --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_female_angry --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_female_angry --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_female_sad --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_female_sad --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_female_sad --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_male_angry --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_male_angry --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_male_angry --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_male_sad --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_male_sad --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_financial_system_male_sad --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_female_angry --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_female_angry --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_female_angry --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_female_sad --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_female_sad --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_female_sad --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_male_angry --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_male_angry --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_male_angry --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_male_sad --prompt safety-evaluation-jailbreak-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_male_sad --prompt safety-evaluation-jailbreak-v1-loose --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_medical_system_male_sad --prompt safety-evaluation-jailbreak-v1-strict --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_illegal_activities_guidance_female_angry --prompt safety-evaluation-illegal_activities_guidance-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_illegal_activities_guidance_female_sad --prompt safety-evaluation-illegal_activities_guidance-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_illegal_activities_guidance_male_angry --prompt safety-evaluation-illegal_activities_guidance-v1 --model gpt-4o-gemini-2.5-flash
...
python main.py --dataset safety_illegal_activities_guidance_male_sad --prompt safety-evaluation-illegal_activities_guidance-v1 --model gpt-4o-gemini-2.5-flash
