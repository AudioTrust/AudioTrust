...
```bash
git clone https://github.com/AudioTrust/AudioTrust.git
cd AudioTrust
...
dataset = load_dataset("xxx/AudioTrust", split="hallucination")
```
...
```bash
python utils/materialize_hf_audio.py --dataset-path AudioTrust/AudioTrust
```
